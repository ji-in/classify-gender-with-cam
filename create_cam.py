...
def create_cam(config):
    ...
    vgg._modules.get(finalconv_name).register_forward_hook(hook_feature)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='gender_classifier_params.pt')
    # parser.add_argument('--model_name', type=str, default='model.pth')

    parser.add_argument('--result_path', type=str, default='./result')
    parser.add_argument('--img_size', type=int, default=128)
    parser.add_argument('--num_result', type=int, default=30)
